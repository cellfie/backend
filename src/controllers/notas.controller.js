...
SELECT 
  ...
  n.completada, 
  n.fecha_creacion,
  DATE_FORMAT(CONVERT_TZ(n.fecha_creacion, '+00:00', '-03:00'), '%Y-%m-%d %H:%i') as fecha_creacion_formatted,
  n.fecha_completada,
  DATE_FORMAT(CONVERT_TZ(n.fecha_completada, '+00:00', '-03:00'), '%Y-%m-%d %H:%i') as fecha_completada_formatted,
  n.punto_venta_id,
